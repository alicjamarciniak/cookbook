...
const HeroSection = () => {
  return (
    <div
      className="h-[100vh] w-[100vw] lg:w-[80vw] flex flex-row m-auto md:bg-none md:bg-dark-green relative
    ...
    >
      <div className="flex flex-1 flex-col justify-end md:justify-start relative">
        ...
        md:text-light-orange font-eczar text-6xl sm:text-7xl md:text-8xl mt-[12vh] p-5 animate-fade-up"
        >
          Finally, all your favorite recipes in one place
        </h3>
        <div className="hidden md:block py-12 md:bg-dark-green w-full">
        ...
        <div className="animate-fade-down">
          ...
          <div className="flex flex-col lg:flex-row w-full justify-center items-center md:items-start gap-4 md:gap-10">
            <Link href="/search">
              ...
              w-[300px] max-w-[300px] lg:hover:max-w-[400px] lg:hover:w-[400px]"
              >
            ...
            <OutlinedButton
              ...
              className="w-[300px] max-w-[300px] lg:hover:max-w-[400px] lg:hover:w-[400px]
      ...
      <div className="hidden h-[90vh] md:flex flex-1 justify-end">
        <div className="relative">
          <div className="absolute top-0 left-0">
            <svg height="90vh" viewBox="0 0 70 350">
              <polygon points="0,0 70,0 0,350" className="fill-dark-green" />
            </svg>
          </div>
          <Image alt="burger" src="/img/burger-guy.jpg" className="h-[90vh]" />
        </div>
      </div>
    </div>
  );
